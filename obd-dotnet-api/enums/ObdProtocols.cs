...
{
    /// <summary>
    /// An "ENUM" containing all OBD Protocols.
    /// </summary>
    public class ObdProtocols
    {
        ...
        public static readonly ObdProtocols
            Iso142304KwpFast = new ObdProtocols('5', "ISO_14230_4_KWP_FAST"); //Fast init

        public static readonly ObdProtocols
            Iso157654Can = new ObdProtocols('6', "ISO_15765_4_CAN"); //11 bit ID, 500 kbaud

        public static readonly ObdProtocols
            Iso157654CanB = new ObdProtocols('7', "ISO_15765_4_CAN_B"); //29 bit ID, 500 kbaud

        public static readonly ObdProtocols
            Iso157654CanC = new ObdProtocols('8', "ISO_15765_4_CAN_C"); //11 bit ID, 250 kbaud

        public static readonly ObdProtocols
            Iso157654CanD = new ObdProtocols('9', "ISO_15765_4_CAN_D"); //29 bit ID, 250 kbaud

        public static readonly ObdProtocols
            SaeJ1939Can = new ObdProtocols('A', "SAE_J1939_CAN"); //29 bit ID, 250 kbaud (user adjustable)

        public static readonly ObdProtocols
            User1Can = new ObdProtocols('B', "USER1_CAN"); //11 bit ID (user adjustable), 125 kbaud (user adjustable)

        public static readonly ObdProtocols
            User2Can = new ObdProtocols('C', "USER2_CAN"); //11 bit ID (user adjustable), 50 kbaud (user adjustable)

        /// <summary>
        /// All Protocols in order of their numeric value
        /// </summary>
        ...
        /// <summary>
        /// the hex char of the numeric value of this protocol (0-C)
        /// </summary>
        public char Value { get; private set; }

        /// <summary>
        /// the human readable name of this protocol
        /// </summary>

...
{
    public class TroubleCodesCommandTest : TroubleCodesCommand
    {
        /**
        ...
        {
            var mockIn = new MemoryStream();
            mockIn.Write(Encoding.ASCII.GetBytes("43 01 03 01 04 01 05>"));
            mockIn.Flush();
            mockIn.Position = 0;
        ...
        {
            var mockIn = new MemoryStream();
            mockIn.Write(Encoding.ASCII.GetBytes("43 01 03 01 04 00 00>"));
            mockIn.Flush();
            mockIn.Position = 0;
        ...
        {
            var mockIn = new MemoryStream();
            mockIn.Write(Encoding.ASCII.GetBytes($"43 02 01 20 01 21>"));
            mockIn.Flush();
            mockIn.Position = 0;
        ...
        {
            var mockIn = new MemoryStream();
            mockIn.Write(Encoding.ASCII.GetBytes($"43 NO DATA>"));
            mockIn.Flush();
            mockIn.Position = 0;
